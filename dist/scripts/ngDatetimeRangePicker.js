	    ...
	    _createClass(NgDatePickerController, [{
	        ...
	        value: function setWatchers() {
	            ...
	            this.Scope.$watch('value', function (v) {
	                ...
	                _this.setFormatVal(v.start, v.end, _this.format);
	            }, true);
	        }
	    }, {
	        key: 'setFormatVal',
